...
class VocResSqueezeDet5D(ModelSkeleton):
  ...
  def _add_forward_graph(self):
    ...
    pool7 = self._pooling_layer(
        'pool7', fire7, size=3, stride=2, padding='VALID')

    fire8 = self._fire_plus_layer(
  ...
  def _fire_plus_layer(self, layer_name, inputs, s1x1, e1x1, e3x3, freeze=False):
      """Fire_plus layer constructor. Add bypass layer to fire module.
